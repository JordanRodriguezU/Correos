...
<html>
    ...
    <body>
        <ul class="nav nav-tabs" id="myTab">
            <li onclick="Events.Salida()" class="active" ><a href="#Main2" data-toggle="tab">Salida</a></li>

            <li id="tab2" onclick="Events.Enviados()" ><a href="#Main1" data-toggle="tab">Enviados</a></li>
