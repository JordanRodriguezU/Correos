            ...
            <div class="container-fluid">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo base_url('Enviados/logout'); ?>">Salir</a></li> </ul>
        ...
        <div class="tab-pane fade in active" id="Main2">
            ...
            <div id="Mails" class='container'>
                ...
                <?php foreach ($result->result() as $row) {
                    ?>
                    <a class='linkmailout'> <div class='ContentMail' onclick="Events.ClickCorreoEnviados(this);" data-asunto="<?php echo $row->asunto; ?>" data-contenido="<?php echo $row->contenido ?>" data-destinatario="<?php echo $row->destinatario ?>" data-id="<?php echo $row->id; ?>" class='col-md-4 mailout'>
        ...
        <script>
            $(document).ready(function () {
                ...
                setInterval(function () {
                    Events.SelectAllCorreoByJsonSent("<?php echo $correo; ?>", "<?php echo $id; ?>", "<?php echo base_url('correos/LoadCorreosEnviados') ?>");
                }, 1000);
